...
FilterFade.prototype = {
	...
	startAtTime: function(fadeTarget, filterFreq, time){
		...
		var fadeTarget = fadeTarget;
		var filterFreq = filterFreq;

		var fadeConstantFilter;
		var fadeConstantGain;

		setTimeout(function(){
			fadeConstantFilter.biquad.frequency.value = filterFreq;
			fadeConstantGain.gain.gain.value = fadeTarget;
		}, time*1000);
